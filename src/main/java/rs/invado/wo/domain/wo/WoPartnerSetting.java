...
public class WoPartnerSetting implements java.io.Serializable {
    ...
    public Boolean getApproveCassaSconto() {
        return approveCassaSconto;
    }

    public void setApproveCassaSconto(Boolean approveCassaSconto) {
        this.approveCassaSconto = approveCassaSconto;
    }

    @Transient
    public int getMaxRokPlacanja() {
        return maxRokPlacanja;
    }

    public void setMaxRokPlacanja(int maxRokPlacanja) {
