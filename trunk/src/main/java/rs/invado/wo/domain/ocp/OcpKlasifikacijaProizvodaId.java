...
/**
 * OcpKlasifikacijaProizvodaId generated by hbm2java
 */
@Embeddable
public class OcpKlasifikacijaProizvodaId  implements java.io.Serializable {
    ...
    public OcpKlasifikacijaProizvodaId() {
    }

    public OcpKlasifikacijaProizvodaId(int vrstaKlasifikacije, String klasifikacija, int proizvod) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof OcpKlasifikacijaProizvodaId) ) return false;
		 OcpKlasifikacijaProizvodaId castOther = ( OcpKlasifikacijaProizvodaId ) other; 
