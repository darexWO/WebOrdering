...
<div class="content">
    ...
    <c:forEach items="${productList}" var="item">
            	<div class="product_item">
                    ...
                    <div class="kol_pak ellipsis">Kolièina po pakovanju: ${item.kolicinaPoPakovanju} ${item.jedinicaMere.skracenaOznaka}</div>
                    <div class="kolicina">Poruèiti: <input type="text" id="orderedQuantity-${item.proizvod}" value=""/>${item.jedinicaMereAltRef.skracenaOznaka}</div>
